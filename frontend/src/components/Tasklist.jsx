       ...
       <div>
                    {
                      ...
                      <div className='flex gap-2 rounded-xl overflow-x-auto  custom-scrollbar pb-5 '>
                        {
                          tasks?.map(x=>{
                            return  <div key={x._id} className="flex flex-col gap-1 overflow-x-auto items-start   justify-between min-w-80 max-w-100 items-center p-3 border hover:bg-[#B6FF3B] bg-[#B6FF3B]/90 text-[#0C1A2B] rounded-xl ">
                    ...
                    <button className='bg-red-600 p-1 rounded-sm text-white'>remove</button>
