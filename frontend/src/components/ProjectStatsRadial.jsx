...
export const ProjectStatsRadial = ({ projects = [] }) => {
  ...
  return (
    <div className="w-full outline-none focus:outline-none focus:ring-0 lg:h-94 bg-[#0C1A2B] rounded-xl p-4">
      ...
      <ResponsiveContainer className='outline-0'>
        <RadialBarChart
          ...
          className='outline-0'
        >
          <RadialBar dataKey="value" className='outline-none focus:outline-none focus:ring-0' cornerRadius={10} />
        </RadialBarChart>
      </ResponsiveContainer>

      <div className="flex bg-[#0C1A2B] p-4 rounded-md outline-0 justify-around mt-2 text-xs">
